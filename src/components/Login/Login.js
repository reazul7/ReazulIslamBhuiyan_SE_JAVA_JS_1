...
const Login = () => {
  ...
  return (
    ...
    <div className="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
      ...
      <button className="relative mt-6 font-semibold border rounded-md py-2 text-sm text-gray-600 bg-gray-100 hover:bg-gray-200" onClick={signInPopUp}>
        ...
        <form action="#">
          ...
          <div className="flex items-center mb-6 -mt-4">
            <div className="flex ml-auto">
              <Link to="/login" className="inline-flex text-xs sm:text-sm text-blue-500 hover:text-blue-700">Forgot Your Password?</Link>
            </div>
          </div>
  
          <div className="flex w-full">
            <Link to="/login" type="submit" className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in">
          ...
          <div className="flex w-full">
            <Link to="/" type="submit" className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in">
              <span style={{transform: "rotate(180deg)"}}>
                <svg className="h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </span>
              <span className="mr-2 uppercase ml-2">Home Page</span>
            </Link>
          </div>
        </form>
      </div>
